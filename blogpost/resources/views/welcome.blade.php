...
<head>
    ...
    <link href="{{ asset('css/style_weather.css') }}" rel="stylesheet">
    <!-- Vendor CSS Files -->
...
<body class="antialiased">
    <div id="app">
        ...
        <main id="main">
            ...
            <div class="hero" style="background-color:#F6F7FF;">
            </div>
            <div class="forecast-table" style="background-color:#F6F7FF;">
                <div class="container">
                    <div class="forecast-container">
                        <div class="today forecast">
                            <div class="forecast-header">
                                <div class="day" style="color:white;">{{strtoupper($day)}}</div>
                                <div class="date" style="color:white;">{{$date}}</div>
                            </div> <!-- .forecast-header -->
                            <div class="forecast-content">
                                <div class="location" style="color:grey;">{{ucfirst($currentWeather['weather'][0]['description'])}}<br>{{$currentWeather['name']}} </div>
                                <div class="degree">
                                    <div class="num">{{round($currentWeather['main']['temp'])}}<sup>o</sup>C</div>
                                    <div class="forecast-icon">
                                        <img src="http://openweathermap.org/img/wn/{{$currentWeather['weather'][0]['icon']}}@4x.png" alt="" width=100>
                                    </div>
                                </div>
                                <small style="color:white;">Feels like {{round($currentWeather['main']['feels_like'])}}<sup>o</sup>C</small>
                            </div>
                        </div>
                        @foreach($futureWeather['list'] as $weather)
                            @if (\Carbon\Carbon::createFromTimestamp($weather['dt'])->format('l') == $day) 
                            @continue
                            @endif
                            <div class="forecast">
                                <div class="forecast-header">
                                    <div class="day" style="color:white;">{{strtoupper(\Carbon\Carbon::createFromTimestamp($weather['dt'])->format('l'))}}</div>
                                </div> <!-- .forecast-header -->
                                <div class="forecast-content">
                                    <div class="forecast-icon">
                                        <img src="http://openweathermap.org/img/wn/{{$weather['weather'][0]['icon']}}@4x.png" alt="" width=80>
                                    </div>
                                    <div class="degree">{{round($weather['temp']['max'])}}<sup>o</sup>C</div>
                                    <small style="color:grey;">{{round($weather['temp']['min'])}}<sup>o</sup></small>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="content d-flex align-items-stretch text-justify" data-aos="fade-right">
                        <div class="content">
                            ...
                            <h4>
                                ...
                                knows about the challenges the digital revolution poses for your business or
                                organization.We
                                work together with you to turn these challenges into opportunities and develop
                                cutting-edge
                                digital solutions that are tailored to you.We began as a small digital firm, and that
                                passion for design continues to define us today.We believe the best interactive
                                experiences
                                come from the sweet harmony of smart design thinking and innovative use of technology.
                                Our
            ...
            <section id="features" class="features" data-aos="fade-up">
                <div class="container">
                    ...
                    <div class="section-title">
                        <h2>Services</h2>
                        <h5>Aidan Technologies is an award-winning agency that offers cutting-edge digital solutions.
                        </h5>
                    </div>
                    ...
                    <div class="row content">
                        ...
                        <div class="col-md-7 pt-4" data-aos="fade-left" data-aos-delay="100">
                            ...
                            <h5>
                                We develop custom-tailored systems and applications that are smart and scalable using
                                the
                                right technologies.
                            </h5>
                        </div>
                    ...
                    <div class="row content">
                        ...
                        <div class="col-md-7 pt-5" data-aos="fade-left">
                            ...
                            <h5>
                                Our team turns ideas into reality. We plan, design and develop your app to suit your
                                needs
                    ...
                    <div class="row content">
                        ...
                        <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
                            ...
                            <h5>
                                SEO must be optimized to increase the quantity and quality of traffic to agency’s
                                website
                    ...
                    <div class="row content">
                        ...
                        <div class="col-md-7 pt-5" data-aos="fade-left">
                            ...
                            <h5>
                                Our app developers build native and hybrid mobile applications on IOS, Android, and
                                Windows,
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up"
                            ...
                            <div class="icon-box">
                                ...
                                <h5>An online software to help governments convert paper forms and documents into web
                                    forms
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info-box">
                                    ...
                                    <h5>Aidan Technologies Sdn Bhd. <br>100-1, Jalan 2/23A, Taman Danau Kota, 53300
                                        Setapak,
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>Our Services</h4>
                            <ul>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">Website & Portal Development</a>
                                </li>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">System & Application Development</a>
                                </li>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">Mobile Application Development</a>
                                </li>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">Security Assessment</a></li>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">Analytics & Business
                                        Intelligence</a>
                                </li>
                                <li><i class="bx bx-chevron-right"></i> <a href="/">Hardware & Software Supplies</a>
                                </li>
                            </ul>
                        </div>
